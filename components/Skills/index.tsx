  ...
  const stackList = [
    {
      ...
      point: [
        ...
        '각 태그의 특성들을 고려하여 오류 없는 코드 작성합니다.',
    ...
    },
    {
      ...
      background: '#FF9E0F',
      point: [
        'let,const를 사용하여 호이스팅 문제점을 방지합니다.',
    ...
    },
    {
      ...
      background: '#071D49',
      point: [
        '타입스크립트를 사용하는 의미를 이해하고 사용하려 합니다.',
    ...
    },
    {
      ...
      point: [
        ...
        '컴포넌트의 성능개선에 대해 고민 하며 리팩토링을 해왔습니다.',
      ],
    },
    {
      title: 'Next.js',
    ...
    },
    {
      ...
      background: '#DB7093',
      point: [
        '요소의 Style을 컴포넌트화 하면서, 코드의 재사용성을 높였습니다.',
